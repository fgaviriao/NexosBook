...
namespace BookApi.Controllers
{
    ...
    public class BooksController : ApiController
    {
        ...
        [HttpGet]
        [ActionName("GetAllByAuthorId")]
        public HttpResponseMessage GetAllByAuthorId(int id)
        {
            return Request.CreateResponse(HttpStatusCode.OK, _service.GetAllByAuthorId(id), Configuration.Formatters.JsonFormatter);
        }
        ...
        [HttpPost]
        public HttpResponseMessage Post(BookDto data)
        {
            try
            {
        ...
        [HttpPut]
        public HttpResponseMessage Put(int id, BookDto data)
        {
            try
            {
